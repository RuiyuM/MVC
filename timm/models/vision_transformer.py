...
class Block(nn.Module):
    ...
    def __init__(self,block_id, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
    ...
    def forward(self, x):
        ...
        self.extracted_k[self.block_id] = self.attn.k.detach().cpu().numpy()
        return x
